...
class NewRestaurantItemAdapter(private val context: Context, private val activity: Activity,
                               internal var itemArrayList: ArrayList<RestaurantItemPojo>,
                               private val menu: Menu) : RecyclerView.Adapter<NewRestaurantItemAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.modular_item_layout_restaurant, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.name.text = " " + itemArrayList[position].submenu_name!!
        holder.brand.text = " " + itemArrayList[position].food_submenu_id!!
        holder.tv_grocery_item_description.text = " " + itemArrayList[position].submenu_desc!!
        ...
        holder.add_to_cart.setOnClickListener { v ->
            ...
            request.pid = itemArrayList[position].food_submenu_id
    ...
    inner class MyViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        internal val tv_grocery_item_description: TextView
        ...
        init {
            ...
            tv_grocery_item_description = itemview.findViewById<View>(R.id.tv_grocery_item_description) as TextView
        }
    }
