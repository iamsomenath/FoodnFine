...
public class RestrurentListActivity_ViewBinding implements Unbinder {
  private RestrurentListActivity target;

  @UiThread
  public RestrurentListActivity_ViewBinding(RestrurentListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public RestrurentListActivity_ViewBinding(RestrurentListActivity target, View source) {
    this.target = target;

    target.recyclerView = Utils.findRequiredViewAsType(source, R.id.rv_recyclerViewRestaurant, "field 'recyclerView'", RecyclerView.class);
    ...
    target.layout_fetchingData = Utils.findRequiredViewAsType(source, R.id.layout_restaurent_fetchingData, "field 'layout_fetchingData'", RelativeLayout.class);
  ...
  @CallSuper
  public void unbind() {
    RestrurentListActivity target = this.target;
