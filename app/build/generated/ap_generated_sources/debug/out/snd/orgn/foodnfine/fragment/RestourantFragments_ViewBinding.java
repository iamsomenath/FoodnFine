...
public class RestourantFragments_ViewBinding implements Unbinder {
  private RestourantFragments target;

  @UiThread
  public RestourantFragments_ViewBinding(RestourantFragments target, View source) {
    this.target = target;

    target.recyclerView = Utils.findRequiredViewAsType(source, R.id.rv_breakFast, "field 'recyclerView'", RecyclerView.class);
    ...
    target.layout_dataNotAvailable = Utils.findRequiredViewAsType(source, R.id.layout_foodList_notFound, "field 'layout_dataNotAvailable'", ConstraintLayout.class);
  ...
  @CallSuper
  public void unbind() {
    RestourantFragments target = this.target;
